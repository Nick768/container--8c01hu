...
> Be patient! In ~3 mins your app is live, at your [app url](https://container--8c01hu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container--8c01hu.containers.anotherwebservice.com/
...
```
git clone git@github.com:Nick768/container--8c01hu.git
cd container--8c01hu
```
...
```
docker attach container--8c01hu
```
